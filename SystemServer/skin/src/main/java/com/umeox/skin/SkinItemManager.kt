...
import com.umeox.skin.entity.Attr
import com.umeox.skin.entity.AttrFactory
import com.umeox.skin.entity.SkinItem
...
class SkinItemManager {
    ...
    fun applySkin() {
        SkinManager.log("applySkin: 应用皮肤")
    ...
    fun applyTextFont(replaceTable:Map<String,String>) {
        SkinManager.log("applySkin: 应用字体")
        for (item in mSkinItems) {
    ...
    private fun buildSkinAttr(context: Context, attrs: AttributeSet, index: Int): Attr? {
        ...
        SkinManager.log("parseSkinAttr: attrName = $attrName")
