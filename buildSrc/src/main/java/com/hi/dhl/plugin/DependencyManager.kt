...
object DependArray {
    val dps = arrayListOf<DependInfo>(
        DependInfo("androidx.core:core-ktx:1.7.0", DependType.IMPLEMENTATION),
        DependInfo("androidx.appcompat:appcompat:1.3.0", DependType.IMPLEMENTATION),
        DependInfo("com.google.android.material:material:1.4.0", DependType.IMPLEMENTATION),
        DependInfo("androidx.constraintlayout:constraintlayout:2.0.4", DependType.IMPLEMENTATION),
        DependInfo("junit:junit:4.13.2", DependType.TEST_IMPLEMENTATION),
        DependInfo("androidx.test.ext:junit:1.1.3", DependType.ANDROID_TEST_IMPLEMENTATION),
        DependInfo("androidx.test.espresso:espresso-core:3.4.0", DependType.ANDROID_TEST_IMPLEMENTATION),
    )
}

data class DependInfo(val schemePath: String, val type: DependType)

enum class DependType {
    KAPT, IMPLEMENTATION, TEST_IMPLEMENTATION, ANDROID_TEST_IMPLEMENTATION,PROJECT
