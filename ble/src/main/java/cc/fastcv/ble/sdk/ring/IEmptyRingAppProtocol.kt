...
/**
 * 提供IRingAppProtocol接口的空实现接口
 * 方便子类按需重写部分方法
 */
interface IEmptyRingAppProtocol : IRingAppProtocol {
     ...
     */
    override fun onBatteryPowerCallback(status: String, bat: String, version: String, versionName: String) {}
